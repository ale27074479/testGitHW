...
public class Homework6 {
    ...
    Cat cat1 = new Cat("Тучка", 2, 200);
    Cat cat2 = new Cat("Киара", 5, 400);
    Dog dog1 = new Dog("Лола", 0.5f, 500);
    Dog dog2 = new Dog("Лео", 1.5f, 350);
    ...
    for (int i = 0; i < animals.length; i++) {
        ...
        eventName = "проплыть на " + animals[i].getMaxSwim() + " метров попытка проплыть на ";
